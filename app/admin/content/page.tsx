          ...
          <TabsContent value="content">
            <Card>
              ...
              <CardContent className="space-y-6">
                ...
                {/* Mission Content */}
                <div className="space-y-2">
                  <Label htmlFor="mission-content">Mission Section</Label>
                  <Textarea
                    id="mission-content"
                    rows={6}
                    value={editingContent["mission"] || ""}
                    onChange={(e) => setEditingContent({ ...editingContent, mission: e.target.value })}
                  />
                  <div className="flex justify-end">
                    <Button
                      onClick={() => updateContent("mission")}
                      disabled={loading}
                    >
                      <Save className="mr-2 h-4 w-4" /> Save Mission Content
                    </Button>
                  </div>
                </div>
                ...
                {/* Money Content */}
                <div className="space-y-2">
                  <Label htmlFor="money-content">Money Section</Label>
                  <Textarea
                    id="money-content"
                    rows={6}
                    value={editingContent["money"] || ""}
                    onChange={(e) => setEditingContent({ ...editingContent, money: e.target.value })}
                  />
                  <div className="flex justify-end">
                    <Button
                      onClick={() => updateContent("money")}
                      disabled={loading}
                    >
                      <Save className="mr-2 h-4 w-4" /> Save Money Content
                    </Button>
                  </div>
                </div>
              </CardContent>
