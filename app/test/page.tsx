    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-gray-100">
        <div className="text-center">
          <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-[#F77665] mx-auto"></div>
      ...
      <div className="flex items-center justify-center min-h-screen bg-gray-100">
        <div className="bg-white p-8 rounded-lg shadow-md max-w-md w-full">
          ...
          <button 
            ...
            className="mt-6 w-full bg-[#F77665] hover:bg-[#F77665] text-white py-2 rounded-lg transition duration-200"
          >
            Try Again
          </button>
        </div>
      ...
      <div className="max-w-md mx-auto bg-white rounded-lg shadow-md overflow-hidden">
        ...
        <div className="p-6">
          ...
          <form onSubmit={handleSubmit}>
            <div className="mb-4">
              ...
              <input
                ...
                className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#F77665]"
                required
              />
            </div>
            ...
            <button
              type="submit"
              disabled={processing}
              className={`w-full bg-[#F77665] hover:bg-[#F77665] text-white py-3 rounded-lg transition duration-200 ${
          ...
          <p className="text-xs text-gray-500 mt-6 text-center">
           {" Your contribution will directly support REPROCOLLECTIVE's initiatives. Thank you for your generosity!"}
          </p>
        </div>
      </div>
    </div>
